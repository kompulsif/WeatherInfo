...
@pytest.fixture
def getResponseData(getDayData: Dict[str, Any], getStationData: Dict[str, Any]) -> Dict[str, Any]:
    return {
        "queryCost": 1,
        "latitude": 39.9272,
        "longitude": 32.8644,
...
def test_wheatherResponse_class(getDayData: Dict[str, Any], getStationData: Dict[str, Any], getResponseData: Dict[str, Any]) -> None:
